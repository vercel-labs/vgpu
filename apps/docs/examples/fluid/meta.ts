export const meta = {
  ...
  files: ['example.ts', 'controls.ts', 'fluid-common.wgsl', 'advect-velocity.wgsl', 'divergence.wgsl', 'pressure.wgsl', 'project.wgsl', 'advect-dye.wgsl', 'update-particles.wgsl', 'display.wgsl', 'particles.wgsl'],
} as const;
