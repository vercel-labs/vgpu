export const meta = {
  ...
  files: ['example.ts', 'simulation.ts', 'controls.ts', 'math.ts', 'fluid-common.wgsl', 'advect-velocity.wgsl', 'divergence.wgsl', 'pressure.wgsl', 'project.wgsl', 'advect-dye.wgsl', 'display.wgsl'],
} as const;
