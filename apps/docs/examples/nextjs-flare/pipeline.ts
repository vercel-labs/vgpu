...
export class FlarePipeline {
  ...
  constructor(gpu: Gpu, output: Target) {
    ...
    this.effects = {
      logo: gpu.effect(withTopLeftFullscreen(logoWgsl), { label: 'nextjs-flare-logo' }),
      rim: gpu.effect(withTopLeftFullscreen(rimWgsl), { label: 'nextjs-flare-rim' }),
      rimBlurH: gpu.effect(withTopLeftFullscreen(blurWgsl), {
        label: 'nextjs-flare-rim-horizontal',
      }),
      rimBlurV: gpu.effect(withTopLeftFullscreen(blurWgsl), {
        label: 'nextjs-flare-rim-vertical',
      }),
      composite: gpu.effect(withTopLeftFullscreen(compositeWgsl), {
