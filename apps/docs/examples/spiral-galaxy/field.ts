...
export const STROKES: readonly StrokeSpec[] = [
  { depth: 0.62, speed: 0.025, strong: true },
  { depth: -0.46, speed: -0.018, strong: false },
  { depth: 0.78, speed: 0.021, strong: true },
  { depth: -0.7, speed: -0.016, strong: false },
  { depth: 0.42, speed: 0.03, strong: true },
];
