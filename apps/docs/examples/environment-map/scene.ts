/** Shared environment-map scene and browser lifecycle; renderer.ts is public. */
...
export function render(currentFrame: Frame, scene: Scene, output: Output, view: CameraView, time: number): void {
  scene.cube.set({
