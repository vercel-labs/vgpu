...
export type AgentRadianceAnimation = 'centre-out' | 'edge-orbit' | 'edge-then-centre';
...
export const AGENT_RADIANCE_ANIMATIONS: readonly {
  ...
  { value: 'centre-out', label: 'Centre-out wave' },
  { value: 'edge-orbit', label: 'Orbiting edge' },
  { value: 'edge-then-centre', label: 'Edges, then centre' },
];
