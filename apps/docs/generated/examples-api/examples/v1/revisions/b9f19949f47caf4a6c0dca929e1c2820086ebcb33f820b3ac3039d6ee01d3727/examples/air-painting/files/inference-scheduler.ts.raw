 ...
 *
 * This module follows the single-flight pump pattern established by the
 * neural-shader example, but the semantics differ enough to be its own file: this
 * one is producer-driven and coalescing, not a self-scheduling animation loop.
