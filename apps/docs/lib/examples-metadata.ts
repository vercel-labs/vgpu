...
import { meta as throwableFluidMeta } from '../examples/throwable-fluid/meta';
...
const rawMetadata = {
  ...
  'throwable-fluid': throwableFluidMeta,
...
export const exampleMetadataBySlug = {
  ...
  'throwable-fluid': withThumbnails(rawMetadata['throwable-fluid']),
