...
The entry shader can import reusable functions, structs, aliases, and constants from other `.wgsl` files. Learn the authoring model and pure-module rule in [WGSL modules](/docs/concepts/wgsl-modules).
