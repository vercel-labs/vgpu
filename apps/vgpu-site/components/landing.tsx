...
export function Header() {
  return (
    <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-tab-5 py-tab-4 text-tab-3 text-muted-foreground md:px-tab-8">
      <a href="#top" className="flex items-center gap-tab-2 text-foreground" aria-label="VGPU home">
        <span className="grid size-block-0.5 place-items-center rounded-tab-2 border border-border bg-foreground text-tab-3 font-semibold text-[#050505]">
          V
        </span>
      ...
      <a
        className="rounded-tab-2 border border-border px-tab-3 py-tab-1.5 text-tab-3 text-foreground transition hover:border-foreground"
  ...
  return (
    <section id="top" className="relative overflow-hidden border-b border-border">
      ...
      <div className="relative mx-auto flex min-h-[760px] w-full max-w-7xl flex-col items-center justify-center px-tab-5 py-block-2 text-center md:px-tab-8">
        <p className="mb-tab-4 rounded-full border border-border bg-background/70 px-tab-3 py-tab-1.5 text-tab-3 text-muted-foreground backdrop-blur">
        ...
        <div className="mt-tab-8 flex flex-col gap-tab-3 sm:flex-row">
          <a className="inline-flex h-block-1.5 items-center justify-center gap-tab-2 rounded-tab-2 bg-foreground px-tab-5 text-tab-3 font-medium text-[#050505] transition hover:bg-muted-foreground" href="#docs">
            Get started <Arrow />
          </a>
          <a className="inline-flex h-block-1.5 items-center justify-center gap-tab-2 rounded-tab-2 border border-border bg-background/70 px-tab-5 text-tab-3 font-medium text-foreground backdrop-blur transition hover:border-foreground" href="#comparison">
            Compare APIs
          </a>
        </div>
      </div>
  ...
  return (
    <article className="overflow-hidden rounded-site border border-border bg-muted/70 shadow-2xl shadow-black/40">
      <div className="flex items-center justify-between border-b border-border px-tab-4 py-tab-3">
        <div>
          <p className="text-tab-2.5 uppercase tracking-[0.24em] text-muted-foreground">{eyebrow}</p>
    ...
    <section id="comparison" className="border-b border-border px-tab-5 py-block-3 md:px-tab-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-tab-8 max-w-3xl">
          <p className="text-tab-3 uppercase tracking-[0.24em] text-muted-foreground">Native WebGPU vs VGPU</p>
      ...
      <div className="mx-auto max-w-7xl">
        <div className="flex flex-col justify-between gap-tab-6 md:flex-row md:items-end">
          <div className="max-w-2xl">
            <p className="text-tab-3 uppercase tracking-[0.24em] text-muted-foreground">Feature pillars</p>
        ...
        <div className="mt-tab-8 grid gap-tab-3 md:grid-cols-2 lg:grid-cols-3">
          {pillars.map((pillar, index) => (
            <article key={pillar.title} className="min-h-block-5 rounded-site border border-border bg-muted/45 p-tab-5 transition hover:border-[#52525b]">
              <p className="font-mono text-tab-3 text-muted-foreground">0{index + 1}</p>
  ...
  return (
    <section id="workflow" className="border-b border-border px-tab-5 py-block-3 md:px-tab-8">
      <div className="mx-auto grid max-w-7xl gap-tab-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div>
          <p className="text-tab-3 uppercase tracking-[0.24em] text-muted-foreground">Agentic and headless</p>
        ...
        <div className="rounded-site border border-border bg-background p-tab-3">
          <div className="rounded-tab-3 border border-border bg-muted p-tab-5">
            <div className="flex items-center justify-between border-b border-border pb-tab-4">
              <div>
                <p className="text-tab-2.5 uppercase tracking-[0.24em] text-muted-foreground">Pipeline</p>
                <h3 className="mt-tab-1 text-[18px] font-medium">Headless visual loop</h3>
              </div>
              <span className="rounded-full border border-border px-tab-2 py-tab-1 text-tab-2.5 text-muted-foreground">CI ready</span>
            </div>
  ...
  return (
    <section className="border-b border-border px-tab-5 py-block-3 md:px-tab-8">
      <div className="mx-auto max-w-7xl rounded-[24px] border border-border bg-gradient-to-br from-muted to-background p-tab-6 md:p-tab-8">
        <p className="text-tab-3 uppercase tracking-[0.24em] text-muted-foreground">Native escape hatch</p>
  ...
  return (
    <section id="docs" className="px-tab-5 py-block-3 md:px-tab-8">
      <div className="mx-auto flex max-w-4xl flex-col items-center text-center">
        <p className="text-tab-3 uppercase tracking-[0.24em] text-muted-foreground">Docs and artifacts</p>
        ...
        <div className="mt-tab-8 flex flex-col gap-tab-3 sm:flex-row">
          <a className="inline-flex h-block-1.5 items-center justify-center rounded-tab-2 bg-foreground px-tab-5 text-tab-3 font-medium text-[#050505]" href="/preview">Open component preview</a>
          <a className="inline-flex h-block-1.5 items-center justify-center rounded-tab-2 border border-border px-tab-5 text-tab-3 font-medium" href="https://github.com/vercel-labs/vgpu/tree/main/packages">Read packages</a>
        </div>
      </div>
    </section>
  );
...
export function Footer() {
  return (
    <footer className="border-t border-border px-tab-5 py-tab-6 text-tab-3 text-muted-foreground md:px-tab-8">
