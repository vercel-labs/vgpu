...
export function Footer() {
  return (
    <footer className="border-t border-border px-tab-5 py-tab-6 text-[12px] text-muted-foreground md:px-tab-8">
      <div className="mx-auto flex max-w-7xl flex-col justify-between gap-tab-3 md:flex-row md:items-center">
        <p>VGPU standalone site app · apps/vgpu-site</p>
        <p className="font-pixel text-[13px] lowercase tracking-[0.36em] text-foreground/80" aria-hidden="true">vgpu</p>
