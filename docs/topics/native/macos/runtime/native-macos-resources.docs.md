---
title: Earlier proposal — Resources and Metal interop
summary: Earlier proposal for runtime-owned resources, readback, and Metal interop wrappers.
...
# Earlier proposal — Resources and Metal interop

> Warning: This page preserves the earlier Swift-runtime proposal, which the direct Metal workflow
> replaced. Its resource wrappers and ownership model are not current commitments. Start with
> [Bind Metal buffers](/native/macos/metal/bindings) for application-owned Metal resources.
