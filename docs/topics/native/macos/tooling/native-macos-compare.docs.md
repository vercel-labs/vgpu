---
title: Earlier proposal — Compare WebGPU and Metal
summary: Earlier proposal for a cross-backend fixture runner, normalized pixels, and logical trace comparison.
websitePath: /native/macos/compare
keywords: macos, metal, webgpu, compare, parity, fixture, runner, pixel diff
relatedSymbols:
  - effect
  - draw
  - compute
...
# Earlier proposal — Compare WebGPU and Metal

> Warning: This page preserves the earlier comparison-runner proposal, which is not part of the
> direct Metal workflow. Its command and fixture protocol are not current commitments. Start with
> [Build and verify a Metal package](/native/macos/metal/tooling/build) for the supported command surface.
