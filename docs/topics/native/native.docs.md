---
title: Native
summary: Explore a proposal for bringing the vgpu rendering model to native platforms with ahead-of-time compiled WGSL and a small platform runtime.
websitePath: /native
keywords: native, native shaders, ahead of time, aot, metal, metallib, swift, gpu runtime
relatedSymbols:
  - init
  - surface
  - target
