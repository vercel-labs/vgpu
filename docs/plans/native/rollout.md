...
canaries. Backend-neutral semantic extraction first produces layouts, entry interfaces, bindings,
and the exact active typed override set. Production translation then constructs a deterministic
