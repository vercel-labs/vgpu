...
- **getting-started** — Use this router when you arrive through npx vgpu docs and need the right document, not a full tutorial.  `references/guides/getting-started.docs.md`
