...
export { degToRad, Mesh, srgb } from "./scene/geometry-src/index.ts";
...
export type { MeshPrimitive, Vec3, VertexAttributes, VertexLayoutKind } from "./scene/geometry-src/index.ts";
