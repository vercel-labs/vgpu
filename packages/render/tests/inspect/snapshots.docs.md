...
If `Mesh.box` geometry, `wireframeMaterial`, `normalDebugMaterial`, or
...
2. Visually inspect each PNG. Expected appearance:
   ...
   - `box-wireframe-side.png`: looking mostly down the -X axis with slight elevation and slight Z offset; right face dominates with slivers of top and front faces visible.
