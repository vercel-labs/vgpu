...
export { StructuredUniform } from "./structured-uniform.ts";
...
export type { ScalarUniformType, StructuredUniformOptions, UniformValues, VectorUniformInput } from "./structured-uniform.ts";
