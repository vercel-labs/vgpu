 ...
 * 127.0.0.1 that replays a generated artifact tree with the same headers the Next route handlers
...
import { exampleSources } from "../apps/docs/lib/examples-source.generated";
import { adaptCanonicalSourceExport } from "../apps/docs/lib/examples-api/adapter-v1";
import { generateExampleArtifacts } from "../apps/docs/lib/examples-api/artifact-generator";
import { sourceSnapshotIdentity } from "../apps/docs/lib/examples-api/hashing";
...
// ---------------------------------------------------------------------------
// Full-tree crawl against a replay of an artifact tree generated by this test
// ---------------------------------------------------------------------------
...
const generatedArtifacts = generateExampleArtifacts(
  adaptCanonicalSourceExport(exampleSources, {
    repository: "https://github.com/vgpu/vgpu",
    gitCommit: sourceSnapshotIdentity("verify-examples-api-deployment-test\n"),
  }),
);
...
/** Serves the generated tree exactly like the Next route handlers do (headers included). */
...
test("a faithful deployment verifies green over the whole tree", async () => {
  ...
  // The whole generated tree, not just the three artifacts the generator's own hook checks.
